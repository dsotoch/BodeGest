        ...
        <div class="col-md-4 col-lg-2 col-xl-4 col-xxl-2">
            <div class="card h-md-100 ecommerce-card-min-width">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                    <div class="row">
                        <div class="col">
                            <p class="font-sans-serif lh-1 mb-1 fs-4" id="stock">{{ $stock }}</p><span
                                class="badge badge-soft-success rounded-pill fs--2">{{ $porcentaje }}%</span>
                        </div>
                        <div class="col-auto ps-0">

                            <img src="{{ asset('imagenes/articulos/conStock.png') }}" alt=""
                                class="echart-bar-weekly-sales h-100"
                                style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;"
                                _echarts_instance_="ec_1680579470913">
        ...
        <div class="col-md-4 col-lg-2 col-xl-4 col-xxl-2">
            <div class="card h-md-100 ecommerce-card-min-width">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                    <div class="row">
                        <div class="col">
                            <p class="font-sans-serif lh-1 mb-1 fs-4" id="sin-stock">{{ $sin_stock }}</p><span
                                class="badge badge-soft-success rounded-pill fs--2">{{ $porcentaje_sin_stock }}%</span>
                        </div>
                        <div class="col-auto ps-0">

                            <img src="{{ asset('imagenes/articulos/sinStock.png') }}" alt=""
                                class="echart-bar-weekly-sales h-100"
                                style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;"
                                _echarts_instance_="ec_1680579470913">
                    ...
                    <div class="row h-100 justify-content-between g-0">
                        <div class="col-12 col-sm-12 col-xxl-12 pe-2 d-flex justify-content-center align-items-center">
                            ...
                            <div class="btn-group-vertical" role="group" aria-label="Vertical button group"
                                role="group">
                                <button class="btn btn-falcon-success me-1 mb-1 btn-icon-prepend" type="button"
                                    title="Click para Agregar un Nuevo Articulo" data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop"><i class="fa fa-plus btn-icon-text"></i>
                                    Agregar</button>
                                <button class="btn btn-falcon-success me-1 mb-1 btn-icon-prepend" type="button"><i
                                        class="fa fa-edit btn-icon-text"></i> Modificar</button>
                                <button class="btn btn-falcon-success me-1 mb-1 btn-icon-prepend" type="button" id="btn-borrar"><i
                                        class="fa fa-trash-alt btn-icon-text"></i> Eliminar</button>
                                <button class="btn btn-falcon-success me-1 mb-1 btn-icon-prepend" type="button" id="btn-borrar-todo"><i
                                        class="fa fa-trash-alt btn-icon-text"></i> BorrarTodo</button>
                        ...
                        <div class="row">
                                        ...
                                        <div class="d-flex">
                                            <form class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-md-4 position-relative">
                                                    ...
                                                    <input class="form-control" id="stock-form" type="number"
                                                        step="0.01" required="" />
                                                ...
                                                <div class="col-md-4 position-relative">
                                                    ...
                                                    <input class="form-control" id="precioCompra" type="number"
                                                        step="0.01" required="" />
                                                ...
                                                <div class="col-md-4 position-relative">
                                                    ...
                                                    <input class="form-control" id="precioVenta" type="number"
                                                        step="0.01" aria-describedby="precioVenta" required="" />
                                                ...
                                                <div class="col-md-5 position-relative">
                                                    ...
                                                    <select id="unidad_medida_form" name="unidad_medida_form"
                                                ...
                                                <div class="col-md-5 position-relative">
                                                    <label class="form-label"
                                                        for="validationTooltipUsername">Presentación</label>
                                                ...
                                                <div class="col-md-2 position-relative">
                                                    <label class="form-label" for="validationTooltipUsername">Lucro
                                                        %</label>
                                                    <input class="form-control" type="number" name="ganancia"
                                                        id="ganancia" required="">
                                                ...
                                                <div class="col-12">
                                                    <button class="btn btn-primary" type="submit"
                                                        id="btn-registrar-articulo">Registrar</button>
                                            ...
                                            <div class="dropdown dropend">
                                                <button style="background-color: green !important;"
                                                    ...
                                                    title="Click para Calcular Precios por Presentación"
                                                    id="btn-precio-minorista"><span class="fas fa-plus"></span></button>
                                                <div class="dropdown-menu">
                                                    <h6 class="dropdown-header py-0 px-3 mb-0"
                                                        style="background-color:orangered;color: white;">Precios por
                                                        Presentación</h6>
                                                    <div class="dropdown-divider"></div>
                                                    <div class="px-3">
                                                        <label class="badge-soft-danger dropdown-item rounded-1 mb-2"
                                                            type="button" id="unidad"></label>
                                                        <label class="badge-soft-primary dropdown-item rounded-1 mb-2"
                                                            type="button" id="precio"></label>
                                                    ...
                                                    <div class="px-3">
                                                        ...
                                                        <button class="badge-soft-success dropdown-item rounded-1 mb-2"
                                                            type="button" id="forma-presentacion"></button><label
                                                            class="badge-soft-success dropdown-item rounded-1 mb-2"
                                                            style="font-weight: bold;" for="forma-presentacion"
                                                            id="medida-presentacion"></label>
                                                    </div>
                                                    <div class="dropdown-divider"></div>
                                                    <div class="px-3">
                                                        <button
                                                            class="btn btn-sm d-block w-100 btn-outline-primary border-400"
                                                            id="btn-calcular-precios">Calcular
                                                            Precios</button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-3">
                                ...
                                <ul class="nav flex-lg-column fs--1">
                                    <li class="nav-item me-2 me-lg-0"><span class="fas fa-user me-2"></span>Unidad de
                                        Medida<select id="unidad_medida" name="unidad_medida"
                                            class=" nav-link-card-details">
                                            <option value="unidad">Unidad</option>
                                            <option value="litro">Litro</option>
                                            <option value="kilogramo">Kilogramo</option>
                                            <option value="metro">Metros</option>
                                    ...
                                    <li class="nav-item me-2 me-lg-0"><span class="fas fa-ring me-2"></span>Cantidad<input
                                            class="nav-link-card-details" type="number" step="0.01"
                                            id="cantidad_articulos"
                                            placeholder=" cantidad de artículos que vienen en una cierta cantidad de la unidad de medida"
                                            title=" cantidad de artículos que vienen en una cierta cantidad de la unidad de medida">
                                    </li>
                                    <li class="nav-item me-2 me-lg-0"><span
                                            class="fas fa-money-bill-alt me-2"></span>Costo<input
                                            class=" nav-link-card-details" type="number" step="0.01"
                                            id="costo_articulo" placeholder="total de la compra"
                                            title="total de la compra del articulo"></li>
                                    <center>
                                        <li class="nav-item me-2 me-lg-0"><button class="btn-warning " step="0.01"
                                                id="btn-calcular">Calcular</button> </li>
                                    </center>
                                </ul>
                            </div>
                        </div>
